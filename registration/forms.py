...
class PerfilForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            "img_perfil": forms.ClearableFileInput(
                attrs={"class": "form-control mt-2"}
            ),
            "genero_user": forms.Select(attrs={"class": "form-control mt-2"}),
            "tipo_identificacion": forms.Select(attrs={"class": "form-control mt-2"}),
            "identificacion_usuario": forms.TextInput(
                attrs={"class": "form-control mt-2"}
            ),
